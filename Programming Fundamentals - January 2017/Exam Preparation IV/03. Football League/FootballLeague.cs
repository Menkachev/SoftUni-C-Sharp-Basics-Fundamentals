namespace _03.Football_League
{
    ...
    public class FootballLeague
    {
        public static void Main()
        {
            ...
            //// Dictionary for each, scores and goals.
            ...
            while (true)
            {
                ...
                //// Encript/Reverse teams names in capital/ToUpper letters 
                var firstTeamReversed = match.Groups[1].Value.Reverse().ToArray();
                var secondTeamReversed = match.Groups[2].Value.Reverse().ToArray();

                var firstTeam = new string(firstTeamReversed).ToUpper();
                var secondTeam = new string(secondTeamReversed).ToUpper();
                var firstTeamGoals = int.Parse(match.Groups[3].Value);
                var secondTeamGoals = int.Parse(match.Groups[4].Value);

                //// Put the score and goals for each team in the dictionaries.
