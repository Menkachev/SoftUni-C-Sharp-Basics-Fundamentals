namespace _10.Price_Change_Alert
{
    ...
    {
        // You are assigned to rework a given piece of code which is working without bugs 
        // but is not properly formatted. The given program tracks stock prices and gives 
        // updates about the significance in each price change.Based on the significance, 
        // there are four kind of changes: no change at all(price is equal to the previous), 
